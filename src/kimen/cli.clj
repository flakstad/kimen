(ns kimen.cli
  (:require
   ...
   [kimen.cli.parse :as cli-parse]
   [kimen.cli.usage :as cli-usage]
...
(def secret-usage cli-usage/secret-usage)
(def secret-set-usage-line cli-usage/secret-set-usage-line)
(def secret-get-usage-line cli-usage/secret-get-usage-line)
(def secret-rm-usage-line cli-usage/secret-rm-usage-line)
(def secret-mv-usage-line cli-usage/secret-mv-usage-line)
(def remote-usage cli-usage/remote-usage)
(def sync-usage cli-usage/sync-usage)
(def bundle-usage cli-usage/bundle-usage)
(def map-usage cli-usage/map-usage)
(def init-usage cli-usage/init-usage)
(def run-usage cli-usage/run-usage)
(def render-usage cli-usage/render-usage)
(def envfile-usage cli-usage/envfile-usage)
(def plan-usage cli-usage/plan-usage)
(def doctor-usage cli-usage/doctor-usage)
(def project-usage cli-usage/project-usage)
(def ^:private help-topics (cli-usage/help-topics completion/usage))
...
(def parse-flag-value cli-parse/parse-flag-value)
(def parse-duration-ms cli-parse/parse-duration-ms)
(def parse-json-only-opts cli-parse/parse-json-only-opts)
(def split-before-double-dash cli-parse/split-before-double-dash)
...
(def parse-map-lint-opts cli-parse/parse-map-lint-opts)
(def parse-plan-opts cli-parse/parse-plan-opts)
(def parse-vault-auth-opts cli-parse/parse-vault-auth-opts)
(def parse-vault-rekey-opts cli-parse/parse-vault-rekey-opts)

(def parse-secret-set-opts cli-parse/parse-secret-set-opts)
(def parse-secret-common-opts cli-parse/parse-secret-common-opts)
(def parse-run-opts cli-parse/parse-run-opts)
(def parse-render-opts cli-parse/parse-render-opts)
(def parse-envfile-opts cli-parse/parse-envfile-opts)
(def parse-doctor-opts cli-parse/parse-doctor-opts)

(def parse-bundle-keygen-opts cli-parse/parse-bundle-keygen-opts)
(def parse-bundle-recipient-opts cli-parse/parse-bundle-recipient-opts)
(def parse-bundle-seal-opts cli-parse/parse-bundle-seal-opts)
(def parse-bundle-open-opts cli-parse/parse-bundle-open-opts)
(def parse-remote-name-opts cli-parse/parse-remote-name-opts)
(def parse-remote-upsert-opts cli-parse/parse-remote-upsert-opts)

(def parse-sync-init-opts cli-parse/parse-sync-init-opts)
(def parse-sync-status-opts cli-parse/parse-sync-status-opts)
(def parse-sync-transfer-opts cli-parse/parse-sync-transfer-opts)
(def parse-sync-auto-opts cli-parse/parse-sync-auto-opts)
(def parse-sync-reset-baseline-opts cli-parse/parse-sync-reset-baseline-opts)
(def parse-sync-restore-opts cli-parse/parse-sync-restore-opts)
(def parse-sync-changes-opts cli-parse/parse-sync-changes-opts)
(def parse-sync-resolve-opts cli-parse/parse-sync-resolve-opts)
(def parse-sync-preflight-opts cli-parse/parse-sync-preflight-opts)
(def parse-sync-unlock-opts cli-parse/parse-sync-unlock-opts)

(def parse-init-ci-pr-safety-opts cli-parse/parse-init-ci-pr-safety-opts)
(def parse-init-ci-deploy-opts cli-parse/parse-init-ci-deploy-opts)
(def parse-init-ci-sync-gate-opts cli-parse/parse-init-ci-sync-gate-opts)
...
(def parse-config-show-opts cli-parse/parse-config-show-opts)
