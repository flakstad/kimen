...
func newEnvfileCommand() *cobra.Command {
	...
	cmd.Flags().StringArrayVar(&fileMappings, "file", nil, "file mapping relpath=<value> (repeatable; <value> is secret name [or secret:<name>], const:<literal>, or exec:<command...>; used for envpath validation)")
