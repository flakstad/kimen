...
- Local remote sync: `kimen remote add/get/set/list/rm` + `kimen sync status/conflicts/push/pull/reset-baseline/restore` (including push lock files for shared fs remotes)
